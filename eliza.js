/*
 * elizabot.js v1.1 -- Norbert Landsteiner, mass:werk (www.masswerk.at)
 * elizadata.js     -- DOCTOR script (Weizenbaum, 1966)
 * Combined for trent-buckley.com
 */
...
ElizaBot.prototype.getInitial = function() {
  if (!ElizaBot.prototype.global || !ElizaBot.prototype.global.elizaInitials) return '';
  return elizaInitials[Math.floor(Math.random() * elizaInitials.length)];
};

ElizaBot.prototype.getFinal = function() {
  if (!ElizaBot.prototype.global || !ElizaBot.prototype.global.elizaFinals) return '';
